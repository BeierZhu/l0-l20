function [x, Out] = BOMP(A,y,groups,varargin)
% This is a l21 minimization solver for block orthogonal matching pursuit:
%   minimiza ||x||_{2,1}
%   subject to y = Ax,
% -------------------------------------------------------------------------
% Author: Beier ZHU
...
% Out.iter -- # of iterations taken
    ...
    while true
        ...
        group_id = groups(max_index);
        group_index = find(groups==group_id);
